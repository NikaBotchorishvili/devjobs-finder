...
function Item({
	...
	return (
		<Link href={`/${id}`} className=" shadow-[0_0_20px_5px_rgba(0,0,0,0.1)] dark:bg-veryDarkBlue rounded-xl dark:shadow-none flex flex-col h-[150px] w-[80%] sm:w-[30%] md:w-25% lg:w-[21%] justify-between p-12  box-content relative">
			<img
